...
namespace Character.Components.Movement
{
    public class CharacterMovementComponent : IMovable
    {
        ...
        public void Initialize(CharacterData characterData)
        {
            ...
            speed = characterData.DefaultSpeed;  // Устанавливаем начальную скорость из данных
        }
        ...
        public void Move(Vector3 direction)
        {
            ...
            characterData.CharacterController.Move(move * Speed * Time.deltaTime);  // Используем Speed для управления скоростью
        }
